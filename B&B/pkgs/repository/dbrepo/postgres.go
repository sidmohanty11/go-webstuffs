...
//inserts room restriction in the db
...
// returns true if the specified room is available else false
...
//gets the room by id useful for storing name of the room
...
// gets a slice of all reservations
